...
*[x] Keep track of points, display the points in a corner of the screen
...
*[ ] Add support for a second player, with separate scores for each player. 
You'll need to figure out some way for the second player to control their marble gun...
